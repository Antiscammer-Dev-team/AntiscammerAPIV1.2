...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    #loginSection { max-width: 320px; margin: 2rem auto; }
...
<body>
  <div id="loginSection">
    <h2>Admin login</h2>
    <div class="form-row"><label>Username</label><input type="text" id="loginUser" autocomplete="username"></div>
